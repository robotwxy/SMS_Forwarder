...
var appsecret = "bdf83e7167ed28526799db9c59236a4e"
...
// send text message
func (this *Weixinmp) SendTextMsg(touser string, content string) (string, error) {
	var msg textMsg
	msg.MsgType = "text"
	msg.Text.Content = content
	err := this.sendMsg(touser, &msg)
...
func (this *Weixinmp) sendMsg(touser string, msg interface{}) error {
	...
	str := fmt.Sprintf("ErrMsg:%s, ErrCode:%d\n", rtn.ErrMsg, rtn.ErrCode)
	fmt.Printf("ErrMsg:%s, ErrCode:%d\n", rtn.ErrMsg, rtn.ErrCode)
	v.FieldByName("ToUserName").SetString(str)
	//fmt.Println(msg)
	return nil
}
